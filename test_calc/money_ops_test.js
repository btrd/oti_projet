...
QUnit.test('test sub with negative return', function(assert) {
	var m1 = sinon.createStubInstance(money);
	var m2 = sinon.createStubInstance(money);
	m1.getValue.returns(2);
	m1.getCurrency.returns('EUR');
	m2.getValue.returns(3);
	m2.getCurrency.returns('EUR');
...
QUnit.test('test sub with diff curr', function(assert) {
	var m1 = sinon.createStubInstance(money);
	var m2 = sinon.createStubInstance(money);
	m1.getValue.returns(2);
	m1.getCurrency.returns('CHF');
	m2.getValue.returns(3);
	m2.getCurrency.returns('EUR');
