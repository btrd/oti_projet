...
QUnit.test('test construct money', function(assert) {
	...
	assert.throws(function() {var m1 = new money(-1, 'EUR')},
									MoneyNegativeValueExc,
									'Money Negative Impossible');
	assert.throws(function() {var m2 = new money(1, 'EURO')},
									MoneyTooLongDeviseExc,
									'Too Long Devise');
});
